...
extension TripList: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let identifier = R.reuseIdentifier.routeListCell.identifier
        guard let tripListCell = tableView.dequeueReusableCell(withIdentifier: identifier,
                                                               for: indexPath) as? TripListCell else {
